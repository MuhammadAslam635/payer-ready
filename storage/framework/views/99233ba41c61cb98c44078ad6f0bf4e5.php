                ...
                <tbody class="bg-white divide-y divide-slate-200">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-slate-900"><?php echo e($invoice->user->name ?? 'N/A'); ?></div>
                                <div class="text-xs text-slate-500"><?php echo e($invoice->user->email ?? ''); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showInvoiceModal && $selectedInvoice): ?>
        <?php echo $__env->make('livewire.organization.partials.invoice-detail-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div>
...
<?php /**PATH C:\Users\Ammar\Desktop\Doctor project\payer-ready\resources\views/livewire/organization/invoice-list-component.blade.php ENDPATH**/ ?>