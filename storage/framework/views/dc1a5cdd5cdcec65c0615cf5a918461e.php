        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select wire:model.live="userTypeFilter" 
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $userTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <div class="px-4 pb-4">
                    ...
                    <div class="flex justify-center mb-3">
                        <span class="px-3 py-1 rounded-full text-xs font-medium <?php echo e($cssClasses[$user->user_type->value]); ?>">
                    ...
                    <div class="flex justify-center">
                        <button wire:click="toggleUserStatus(<?php echo e($user->id); ?>)"
                                class="px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 <?php echo e($user->is_active 
                    ...
                    <div class="mt-3 text-xs text-gray-500 dark:text-gray-400 text-center">
                        ...
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <p>Joined <?php echo e($user->created_at->format('M d, Y')); ?></p>
                    </div>
                </div>
            </div>
...
<?php /**PATH E:\payer-ready\resources\views/livewire/super-admin/user/admin-view-all-users-component.blade.php ENDPATH**/ ?>