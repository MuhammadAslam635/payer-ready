                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex gap-1">
                            <button wire:click="sortBy('created_at')" 
                                    class="px-3 py-1 text-xs font-medium rounded-md <?php echo e($sortBy === 'created_at' ? 'bg-primary-100 text-primary-700' : 'bg-white text-slate-600 hover:bg-slate-50'); ?> border border-slate-300">
                                Date
                            ...
                            <button wire:click="sortBy('read_at')" 
                                    class="px-3 py-1 text-xs font-medium rounded-md <?php echo e($sortBy === 'read_at' ? 'bg-primary-100 text-primary-700' : 'bg-white text-slate-600 hover:bg-slate-50'); ?> border border-slate-300">
                                Status
...
</div><?php /**PATH E:\payer-ready\resources\views/livewire/doctor/doctor-notification-component.blade.php ENDPATH**/ ?>