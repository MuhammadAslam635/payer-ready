        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
            <div class="bg-white px-6 py-5">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Payment History -->
                    <!--[if BLOCK]><![endif]--><?php if($selectedInvoice->transactions && $selectedInvoice->transactions->count() > 0): ?>
                        <div>
                            <h4 class="text-sm font-semibold text-gray-900 mb-3">Payment History</h4>
                            <div class="space-y-2">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedInvoice->transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <div class="flex justify-between items-start">
                                            <div class="flex-1">
                                                <p class="text-sm font-medium text-gray-900">
                                                    Payment via <?php echo e($transaction->payment_gateway ?? 'N/A'); ?>

                                                </p>
                                                <p class="text-xs text-gray-500 mt-1">
                                                    Transaction ID: <?php echo e($transaction->gateway_transaction_id ?? 'N/A'); ?>

                                                </p>
                                                <p class="text-xs text-gray-500">
                                                    Date: <?php echo e($transaction->created_at->format('M d, Y h:i A')); ?>

                                                </p>
                                                <?php
                                                    $payment = $transaction->userGatewayPayment();
                                                ?>
                                                <!--[if BLOCK]><![endif]--><?php if($payment && $payment->screenshot_path): ?>
                                                    <a href="<?php echo e(url($payment->screenshot_path)); ?>" target="_blank" class="text-xs text-teal-600 hover:text-teal-800 mt-1 inline-block">
                                                        View Screenshot
                                                    </a>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                            <div class="text-right">
                                                <p class="text-sm font-semibold text-gray-900">$<?php echo e(number_format($transaction->amount, 2)); ?></p>
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                                    <?php if($transaction->status === 'completed' || $transaction->status === 'paid'): ?> bg-green-100 text-green-800
            ...
            <div class="bg-gray-50 px-6 py-4 sm:flex sm:flex-row-reverse gap-3">
                <!--[if BLOCK]><![endif]--><?php if($selectedInvoice->status === 'pending'): ?>
...
<?php /**PATH C:\Users\Ammar\Desktop\Doctor project\payer-ready\resources\views/livewire/doctor/partials/invoice-detail-modal.blade.php ENDPATH**/ ?>