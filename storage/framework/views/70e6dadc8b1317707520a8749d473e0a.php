...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto <?php if($showDeleteModal): ?> block <?php else: ?> hidden <?php endif; ?>">
    ...
    <!-- Modal Backdrop -->
    <!--[if BLOCK]><![endif]--><?php if($showCreateModal || $showEditModal || $showDeleteModal): ?>
        <div class="fixed inset-0 bg-black bg-opacity-50 z-40"></div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div>
<?php /**PATH E:\payer-ready\resources\views/livewire/super-admin/payment-gateway/all-payemnt-gateways-component.blade.php ENDPATH**/ ?>