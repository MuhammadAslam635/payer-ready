    ...
    <div class="bg-white rounded-lg shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-slate-200">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-semibold text-slate-800">All System Notifications</h1>
                                ...
                                <div class="flex-1">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($notifiableUser): ?>
                                        <p class="text-xs text-slate-500 mt-1">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($notifiableUser->organization): ?>
                                                <span class="ml-2">
                                                    <span class="font-medium">Organization:</span> <?php echo e($notifiableUser->organization->name); ?>
...
<?php endif; ?>
                    ...
                    <p class="mt-1 text-sm text-slate-500">No system notifications found.</p>
                </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
...
</div><?php /**PATH C:\Users\Ammar\Desktop\Doctor project\payer-ready\resources\views/livewire/super-admin/super-admin-notification-component.blade.php ENDPATH**/ ?>