...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button.index','data' => ['type' => 'button','wire:click' => 'prevStep','class' => 'px-6 py-2 bg-gray-300 hover:bg-gray-400 text-gray-700 font-semibold rounded-lg transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => 'prevStep','class' => 'px-6 py-2 bg-gray-300 hover:bg-gray-400 text-gray-700 font-semibold rounded-lg transition-colors']); ?>
                                Back
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                        ...
                        <div class="flex items-center gap-4">
                            <!--[if BLOCK]><![endif]--><?php if($currentStep < 7): ?>
                                <!--[if BLOCK]><![endif]--><?php if($currentStep > 1): ?>
                                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button.index','data' => ['type' => 'button','wire:click' => 'skipStep','wire:loading.attr' => 'enabled','wire:target' => 'skipStep','wire:loading.class' => 'opacity-50 cursor-not-allowed disabled:opacity-50 disabled:cursor-not-allowed','class' => 'px-6 py-2 text-text-secondary hover:text-primary-600 transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => 'skipStep','wire:loading.attr' => 'enabled','wire:target' => 'skipStep','wire:loading.class' => 'opacity-50 cursor-not-allowed disabled:opacity-50 disabled:cursor-not-allowed','class' => 'px-6 py-2 text-text-secondary hover:text-primary-600 transition-colors']); ?>
                                        Skip for now
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button.index','data' => ['type' => 'button','wire:click' => 'nextStep','wire:loading.attr' => 'enabled','wire:loading.class' => 'opacity-50 cursor-not-allowed disabled:opacity-50 disabled:cursor-not-allowed','class' => 'px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => 'nextStep','wire:loading.attr' => 'enabled','wire:loading.class' => 'opacity-50 cursor-not-allowed disabled:opacity-50 disabled:cursor-not-allowed','class' => 'px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg transition-colors']); ?>
                                    Continue
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
...
<?php /**PATH E:\payer-ready\resources\views/livewire/registration.blade.php ENDPATH**/ ?>