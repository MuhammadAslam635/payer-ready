<div>
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Specialties Management</h1>
                <p class="mt-1 text-sm text-gray-600">Manage medical specialties and their taxonomy codes</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($specialty->code); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($specialty->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <button wire:click="edit(<?php echo e($specialty->id); ?>)"
...
<?php endif; ?>
                                    ...
                                    <button wire:click="delete(<?php echo e($specialty->id); ?>)"
...
<?php unset($__componentOriginal56804098dcf376a0e2227cb77b6cd00a); ?>
<?php endif; ?>
                                <h3 class="mt-2 text-sm font-medium text-gray-900">No specialties found</h3>
                                <p class="mt-1 text-sm text-gray-500">Get started by creating a new specialty.</p>
                            </td>
                        </tr>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </tbody>
        ...
        <!-- Pagination -->
        <!--[if BLOCK]><![endif]--><?php if($specialties->hasPages()): ?>
                            ...
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                        <?php echo e($editing ? 'Edit Specialty' : 'Create New Specialty'); ?>
...
<?php /**PATH E:\payer-ready\resources\views/livewire/super-admin/specialty/specialty-index.blade.php ENDPATH**/ ?>