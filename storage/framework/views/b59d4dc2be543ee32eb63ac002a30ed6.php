...
<li 
    ...
    x-bind:class="{
        'bg-neutral-300 hover:bg-neutral-100': isFocused(<?php echo \Illuminate\Support\Js::from($value)->toHtml() ?>),
...
<?php endif; ?>
    ...
    <span class="col-start-3 text-start text-black"><?php echo e($slot); ?></span>
</li><?php /**PATH C:\Users\Ammar\Desktop\Doctor project\payer-ready\resources\views/components/ui/select/option.blade.php ENDPATH**/ ?>