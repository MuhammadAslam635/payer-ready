            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($pendingApplications > 0 ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'); ?>">
                            <?php echo e($pendingApplications); ?>

                        </span>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php if($pendingApplications > 0): ?>
                        <a href="<?php echo e(route('doctor.applications')); ?>" wire:navigate class="text-sm text-teal-600 hover:text-teal-800 font-medium">
                            View Applications →
                        </a>
                    <?php else: ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-slate-600">Total Pending:</span>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($pendingLicenses > 0 ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'); ?>">
                            <?php echo e($pendingLicenses); ?>

                        </span>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php if($pendingLicenses > 0): ?>
                        <a href="<?php echo e(route('doctor.applications')); ?>" wire:navigate class="text-sm text-teal-600 hover:text-teal-800 font-medium">
                            View Licenses →
                        </a>
                    <?php else: ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($totalExpirables > 0 ? 'bg-orange-100 text-orange-800' : 'bg-green-100 text-green-800'); ?>">
                            <?php echo e($totalExpirables); ?>

                        </span>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php if($totalExpirables > 0): ?>
                        <a href="<?php echo e(route('doctor.expirables')); ?>" wire:navigate class="text-sm text-teal-600 hover:text-teal-800 font-medium">
                            View Expirables →
                        </a>
                    <?php else: ?>
...
<?php /**PATH C:\Users\Ammar\Desktop\Doctor project\payer-ready\resources\views/components/provider-profile-section.blade.php ENDPATH**/ ?>