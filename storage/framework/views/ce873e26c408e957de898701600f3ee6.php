                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <!--[if BLOCK]><![endif]--><?php if($user->user_type === \App\Enums\UserType::DOCTOR): ?>
                                        <button wire:click="viewPracticeLocations(<?php echo e($user->id); ?>)"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['formData.taxnomy_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['formData.speciality_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                            ...
                                            <div>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['formData.state_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button type="submit" wire:target="save" wire:loading.attr="disabled"
                                ...
                                <span wire:loading.remove wire:target="save"><?php echo e($editing ? 'Update' : 'Create'); ?></span>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showPracticeLocationsModal): ?>
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-medium text-gray-900" id="modal-title">
                                Practice Locations - <?php echo e($selectedProviderName); ?>
                        ...
                        <div class="mt-4">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(empty($practiceLocations)): ?>
                                ...
                                <?php else: ?>
                                    <div class="overflow-x-auto">
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $practiceLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="hover:bg-gray-50">
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm font-medium text-gray-900"><?php echo e($location['practice_name'] ?? 'N/A'); ?></div>
                                                        </td>
                                                        <td class="px-6 py-4">
                                                            <div class="text-sm text-gray-900">
                                                                <?php echo e($location['address_line_1'] ?? ''); ?>

                                                                <!--[if BLOCK]><![endif]--><?php if(!empty($location['address_line_2'])): ?>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900">
                                                                <?php echo e($location['city'] ?? ''); ?>, <?php echo e($location['state'] ?? ''); ?> <?php echo e($location['zip_code'] ?? ''); ?>

                                                            </div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900"><?php echo e($location['office_phone'] ?? 'N/A'); ?></div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <!--[if BLOCK]><![endif]--><?php if($location['is_primary'] ?? false): ?>
                                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Primary</span>
                                                            <?php elseif($location['is_secondary'] ?? false): ?>
...
<?php /**PATH C:\Users\Ammar\Desktop\Doctor project\payer-ready\resources\views/livewire/organization/manage-staff-component.blade.php ENDPATH**/ ?>