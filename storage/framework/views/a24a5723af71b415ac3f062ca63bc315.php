...
<div <?php echo e($attributes->merge(['class' => 'md:grid md:grid-cols-3 md:gap-0'])); ?>>
...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2 w-full">
        <form wire:submit="<?php echo e($submit); ?>">
            <div class="p-4  bg-white sm:pl-6 sm:pr-6 sm:py-6 shadow w-full <?php echo e(isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'); ?>">
                <?php echo e($form); ?>

            </div>

            <!--[if BLOCK]><![endif]--><?php if(isset($actions)): ?>
                <div class="flex items-center justify-end pl-4 pr-0 py-3 bg-gray-50 text-end sm:pl-6 sm:pr-0 shadow sm:rounded-bl-md sm:rounded-br-md">
                    <?php echo e($actions); ?>
...
<?php /**PATH C:\Users\Ammar\Desktop\Doctor project\payer-ready\resources\views/components/form-section.blade.php ENDPATH**/ ?>