...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2 w-full">
        <form wire:submit="<?php echo e($submit); ?>">
            <div class="p-4  bg-white dark:bg-gray-800 sm:pl-6 sm:pr-6 sm:py-6 shadow w-full <?php echo e(isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'); ?>">
                <?php echo e($form); ?>
