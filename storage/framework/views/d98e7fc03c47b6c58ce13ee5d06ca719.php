...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.icon.index','data' => ['name' => 'magnifying-glass','class' => 'col-span-1 col-start-1 row-start-1 !text-neutral-500 dark:!text-neutral-400 !size-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'magnifying-glass','class' => 'col-span-1 col-start-1 row-start-1 !text-neutral-500 dark:!text-neutral-400 !size-5']); ?>
...
</div><?php /**PATH E:\payer-ready\resources\views/components/ui/select/options.blade.php ENDPATH**/ ?>