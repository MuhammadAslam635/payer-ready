                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <button wire:click="edit({{ $licenseType->id }})"
                                            class="text-primary-600 hover:text-primary-900">
                                        <x-ui.icon name="pencil" class="w-4 h-4" />
                                    </button>
                                    <button wire:click="delete({{ $licenseType->id }})"
                            ...
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                        {{ $editing ? 'Edit License Type' : 'Create New License Type' }}
                                    </h3>
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                            @error('formData.issuing_authority') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                        </div>
