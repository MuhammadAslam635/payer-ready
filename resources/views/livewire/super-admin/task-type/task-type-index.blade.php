                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    {{ $taskType->default_priority === 'urgent'
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    {{ $taskType->assignments_count }} users
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $taskType->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                    {{ $taskType->is_active ? 'Active' : 'Inactive' }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('super-admin.task-detail', $taskType->id) }}" wire:navigate
                                    ...
                                    <x-ui.button wire:click="edit({{ $taskType->id }})" size="sm"
                                        class="text-primary-600 hover:text-primary-900 bg-primary-600 rounded-md" variant="primary">
                                        <x-ui.icon name="pencil" class="w-4 h-4" />
                                    </x-ui.button>
                                    <x-ui.button wire:click="delete({{ $taskType->id }})" size="sm"
                                        class="bg-red-500 rounded-md text-red-600 hover:text-red-900" variant="primary">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            @error('formData.default_priority')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                            @enderror
                                        </div>
