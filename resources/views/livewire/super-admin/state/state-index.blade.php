                    ...
                    @forelse($states as $state)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $state->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                            ...
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                        {{ $editing ? 'Edit State' : 'Create New State' }}
                                    </h3>
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <select wire:model="formData.country"
                                                    id="country"
                                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                            ...
                                            @error('formData.country') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                        </div>
