    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-8">
            ...
            <button 
                ...
                class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'pending_payer' ? 'border-teal-500 text-teal-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Pending Payer
                <span class="ml-2 bg-gray-100 text-gray-900 py-0.5 px-2.5 rounded-full text-xs">{{ $stats['pending_payer'] ?? 0 }}</span>
            </button>
            <button 
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mb-6">
                            <div class="flex items-center mb-3">
                                <div class="w-8 h-8 {{ $selectedProvider ? 'bg-teal-500 text-white' : 'bg-gray-300 text-gray-500' }} rounded-full flex items-center justify-center text-sm font-medium mr-3">
                                    2
                                </div>
                                <div>
                            ...
                            <select wire:model="selectedPayer" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500" {{ !$selectedProvider ? 'disabled' : '' }}>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center mb-3">
                                <div class="w-8 h-8 {{ $selectedPayer ? 'bg-teal-500 text-white' : 'bg-gray-300 text-gray-500' }} rounded-full flex items-center justify-center text-sm font-medium mr-3">
                                    3
                                </div>
                                <div>
                            ...
                            <select wire:model="selectedRequestType" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500" {{ !$selectedPayer ? 'disabled' : '' }}>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button 
                            ...
                            type="button" 
                            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-teal-600 text-base font-medium text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:ml-3 sm:w-auto sm:text-sm {{ !$selectedRequestType ? 'opacity-50 cursor-not-allowed' : '' }}"
                            {{ !$selectedRequestType ? 'disabled' : '' }}>
                            Submit Request
                        </button>
                        <button 
