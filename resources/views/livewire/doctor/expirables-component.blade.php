    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200">
        <div class="px-6 py-4 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900">Expirables</h1>
                    <p class="mt-1 text-sm text-slate-600">Review licenses and payer-related credentials with upcoming expirations.</p>
                </div>
            </div>
        </div>
    </div>
