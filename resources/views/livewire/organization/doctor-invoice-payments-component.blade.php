            ...
            <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select wire:model.live="selectedDoctorId" class="w-full text-sm border-slate-300 rounded-md focus:ring-teal-500 focus:border-teal-500">
                        ...
                        <option value="{{ Auth::id() }}">Organization ({{ Auth::user()->business_name ?? Auth::user()->name }})</option>
                    ...
                    <div class="bg-white px-6 py-5">
                        ...
                        <div class="mt-4 space-y-4">
                            <div>
                                ...
                                @error('selectedDoctorId') <p class="text-red-600 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>
