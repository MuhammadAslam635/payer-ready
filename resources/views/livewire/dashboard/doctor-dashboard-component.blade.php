    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg border border-blue-200 p-6 relative">
            ...
            <div class="pr-16">
                ...
                <p class="text-3xl font-bold text-black">{{ number_format($stats['activeLicenses']) }}</p>
                <p class="text-sm text-gray-500 mt-1">{{ $stats['totalLicenses'] }} total licenses</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-blue-200 p-6 relative">
            ...
            <div class="pr-16">
                ...
                <p class="text-3xl font-bold text-black">{{ number_format($stats['verifiedDocuments']) }}</p>
                <p class="text-sm text-gray-500 mt-1">{{ $stats['totalDocuments'] }} total documents</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-blue-200 p-6 relative">
            ...
            <div class="pr-16">
                ...
                <p class="text-3xl font-bold text-black">{{ number_format($stats['totalWorkHistory']) }}</p>
        ...
        <div class="bg-white rounded-lg border border-blue-200 p-6 relative">
            ...
            <div class="pr-16">
                ...
                <p class="text-3xl font-bold text-black">{{ number_format($stats['totalReferences']) }}</p>
        ...
        <div class="bg-white rounded-lg shadow-sm border-2 border-dashed border-slate-300 p-12">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('doctor.profile') }}" wire:navigate class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
