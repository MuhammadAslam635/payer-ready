        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <!-- Doctor Card -->
                    <a href="{{ route('doctor-register') }}" wire:navigate class="block">
                        <div class="border-2 rounded-lg p-6 cursor-pointer transition-all hover:shadow-md hover:border-primary-500 hover:bg-primary-50 border-gray-200">
                            ...
                            <!-- Organization Card -->
                    <a href="{{ route('organization-register') }}" wire:navigate class="block">
                        <div class="border-2 rounded-lg p-6 cursor-pointer transition-all hover:shadow-md hover:border-primary-500 hover:bg-primary-50 border-gray-200">
                                <div class="text-center">
                                    <div class="w-16 h-16 mx-auto mb-4 bg-primary-100 rounded-full flex items-center justify-center">
                                        <svg class="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center mt-8">
                <p class="text-text-secondary">
                    ...
                    <a href="{{ route('login') }}" wire:navigate class="text-primary-600 hover:text-primary-700 font-medium">Sign in here</a>
                </p>
            </div>
        </div>
    </div>
